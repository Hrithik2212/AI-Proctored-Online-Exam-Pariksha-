...
def check(username,password,rollno,email) :
    ...
    rollno=rollno+'\n'
    file_name=open("C://Users/HRITHIK REDDY/Pariksha/main/authentication/stdb.txt","r")
    i=0
    linenumber=0
...
def face(request):
  ...
  if request.method=='POST':
    ...
    while True:
        ...
        haar_cascade = cv.CascadeClassifier("C://Users/HRITHIK REDDY/Pariksha/Main/haar_face.xml")
